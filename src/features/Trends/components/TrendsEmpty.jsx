...
function TrendsEmpty () {
    ...
    return (
        <>
        <div className="border border-(--color-primary) my-7 px-8 pt-10 md:pt-15 rounded-xl text-(--color-primary) 
                        flex flex-col justify-center items-center gap-5 md:gap-7">
            ...
            <h1 className="text-xl md:text-3xl font-semibold">No Data Available for {year}</h1>
        ...
        <p className="text-center text-xs md:text-sm text-(--color-primary)">Data is typically available for years {minYear}–{maxYear-1}. Future predictions coming soon.</p>
        </>
    )
}
