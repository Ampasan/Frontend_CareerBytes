    ...
    return(
      <section id="roadmap" className="scroll-mt-20 max-w-md lg:max-w-full mx-auto">
        ...
        <div className="px-6 lg:pl-22 pt-10 flex justify-center items-center gap-5 lg:gap-10">
          <h2 className="text-(--color-primary) text-3xl lg:text-5xl font-semibold tracking-tight whitespace-nowrap lg:whitespace-normal">Plan Your Career Path</h2>
        ...
        <div className="mb-3 max-w-6xl mx-auto px-6 lg:px-8 ">
          <div className="flex justify-center items-center mt-10 lg:mt-15">
            <h2 className="border border-(--color-primary) font-semibold text-2xl lg:text-4xl p-3 px-5 mb-15 rounded-2xl leading-tight tracking-tight text-(--color-primary)">
            UI/UX Designer
            </h2>
          </div>
