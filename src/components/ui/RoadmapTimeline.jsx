function RoadmapTimeline({ title, description, level, estimate }) {
  return (
    <div className="w-auto max-w-6xl mx-6 md:mx-auto my-8 bg-linear-to-r from-blue-600 to-blue-900 text-white rounded-3xl lg:rounded-2xl shadow-xl px-8 py-10 lg:px-12 lg:py-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-8">
      {/* Left Content */}
